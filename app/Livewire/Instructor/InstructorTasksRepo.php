...
class InstructorTasksRepo extends Component
{
    use WithFileUploads;
    ...
    public function goBackFolder()
    {
       try{
        ...
        $this->fetchAll();
            ...
            $this->previous_folder = [$this->current_folder];
       }
    }
    ...
    public function mount($folder_id)
    {
        $this->current_folder = $folder_id;
        $this->previous_folder = [$folder_id];
        $this->fetchAll();
    }

    public function render()
    {
        return view('livewire.instructor.instructor-tasks-repo');
    }
}

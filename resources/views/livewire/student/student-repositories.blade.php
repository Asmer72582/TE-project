        ...
        <div class="repositories">
            ...
            @if ($current_folder !== null)
                <button style="padding:10px; background:black; color:white; z-index:100; cursor:pointer;"
                    wire:click="goBackFolder" class="btn">Go Back</button>
            @endif
            ...
            <div class="repo-content">
                ...
                @foreach ($ffs as $ff)
                    @if ($ff->is_folder)
                        <div class="repo-file" wire:click="openFolder({{ $ff->ff_id }})"> 
                            ...
                            <div class="file-lower">
                                ...
                                <button class="open-folder btn" style="position: relative; top:35px;"
                                    wire:click="openFolder({{ $ff->ff_id }})">Open</button>

                                    {{-- <button class="open-folder" style="position: relative; top:35px;"
                                    wire:click="openFolder({{ $ff->ff_id }})">Download</button> --}}
                    ...
                    @else
                        <div class="repo-file">
                            ...
                            <div class="file-lower">
                                ...
                                <button class="open-folder btn" style="background: red; outline:none; border:red;"
                                    wire:click="deleteFF({{ $ff->ff_id }})">Delete</button>

<div>
    ...
    <body>
        <div class="header-box">
            ...
            <a class='btn-4' href="{{ route('superadmin.participants') }}" wire:navigate>
                ...
                GROUPS
                <a class="count-4" style="left:300px;">{{ $participants_count }}</a>
            </a>
            <a class='btn-1' href="{{ route('superadmin.notifications') }}" wire:navigate>
            ...
            {{-- <a class='btn-2' href="{{ route('superadmin.repositories') }}" wire:navigate>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <a class='btn-2' href="{{ route('superadmin.tasks') }}" wire:navigate>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                TOTAL TASKS
                <a class="count-2" style="margin-left:-10px;">{{ $tasks_count }}</a>
            </a>
        </div>
